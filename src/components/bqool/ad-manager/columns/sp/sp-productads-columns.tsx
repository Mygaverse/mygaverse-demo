        ...
        <>
            ...
            {isOpen && (
                <Portal>
                    ...
                    >
                        <button onClick={() => { onAction('enable'); setIsOpen(false); }} className="block w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 text-left">Enable Selected</button>
                        <button onClick={() => { onAction('pause'); setIsOpen(false); }} className="block w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 text-left">Pause Selected</button>
                        <button onClick={() => { onAction('archive'); setIsOpen(false); }} className="block w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 text-left">Archive Selected</button>
                    </div>
                </Portal>
            )}
        </>
...
// ============================================================================
export const getSPProductAdsColumns = (
    ...
    return [
        ...
        { 
            ...
            width: '220px',
            render: (row) => <div style={{ width: '220px' }}><EntityCell title={row.goalName || '-'} badges={[<Badge key="g" variant="neutral">Basic</Badge>]} /></div>
        },
        // Metrics
        { 
            key: 'sales', 
