...
// --- SB COLUMNS ---
export const getSBTargetingColumns = (
        ...
        { 
            ...
            render: (row) => (
                <div style={{ width: '300px' }}>
                    <EntityCell title={row.targetingText || '-'} badges={[<Badge key="match" variant="neutral">{row.matchType || 'Broad'}</Badge>]} />
                </div>
            )
        },
        { 
