...
import { DropdownButton } from "@/components/bqool/ui/DropdownButton";
...
export const getSBSearchTermsColumns = (
    ...
    return [
        ...
        // ... (Rest is identical to SP) ...
        { 
            key: 'addedAs', header: 'Added as', width: '200px',
            render: (row) => (
                <Portal>
                    <div className="flex flex-col gap-1 items-start w-[200px] Z-[400]">
